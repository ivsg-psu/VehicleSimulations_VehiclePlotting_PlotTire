% script_test_fcn_PlotTire_fillTireLocalXYZ.m
% tests fcn_PlotTire_fillTireLocalXYZ.m

% REVISION HISTORY:
%
% 2026_02_18 by Sean Brennan, sbrennan@psu.edu
% - In script_test_fcn_PlotTire_fillTireLocalXYZ
%   % * Wrote the code originally, using fcn_PlotTire_fillTireLocalXY as
%   %   % starter
...
% Call the function
cellArrayOfPoints = fcn_PlotTire_fillTireLocalXYZ(tireParameters, (displayModel), ([]));
